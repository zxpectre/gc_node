CREATE OR REPLACE FUNCTION {{SCHEMA}}.asset_utxos(_asset_list text [] [], _extended boolean DEFAULT false)
RETURNS TABLE (
  tx_hash text,
  tx_index smallint,
  address text,
...
COMMENT ON FUNCTION {{SCHEMA}}.asset_utxos IS 'Get UTxO details for requested assets'; -- noqa: LT01
