CREATE OR REPLACE FUNCTION {{SCHEMA}}.asset_nft_address(_asset_policy text, _asset_name text DEFAULT '')
RETURNS TABLE (
...
COMMENT ON FUNCTION {{SCHEMA}}.asset_nft_address IS 'Returns the current address holding the specified NFT'; -- noqa: LT01
