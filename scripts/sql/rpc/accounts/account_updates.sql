CREATE OR REPLACE FUNCTION {{SCHEMA}}.account_updates(_stake_addresses text [])
RETURNS TABLE (
...
COMMENT ON FUNCTION {{SCHEMA}}.account_updates IS 'Get updates (registration, deregistration, delegation and withdrawals) for given stake addresses'; -- noqa: LT01
