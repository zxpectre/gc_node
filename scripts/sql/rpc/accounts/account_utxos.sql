CREATE OR REPLACE FUNCTION {{SCHEMA}}.account_utxos(_stake_addresses text [], _extended boolean DEFAULT false)
RETURNS TABLE (
  tx_hash text,
  tx_index smallint,
  address text,
...
COMMENT ON FUNCTION {{SCHEMA}}.account_utxos IS  'Get UTxO details for requested stake account'; -- noqa: LT01
