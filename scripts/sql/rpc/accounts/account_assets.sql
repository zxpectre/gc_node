CREATE OR REPLACE FUNCTION {{SCHEMA}}.account_assets(_stake_addresses text [])
RETURNS TABLE (
...
COMMENT ON FUNCTION {{SCHEMA}}.account_assets IS 'Get the native asset balance of given accounts'; -- noqa: LT01
