CREATE OR REPLACE FUNCTION {{SCHEMA}}.script_utxos(_script_hash text, _extended boolean DEFAULT false)
RETURNS TABLE (
  tx_hash text,
  tx_index smallint,
  address text,
...
COMMENT ON FUNCTION {{SCHEMA}}.script_utxos IS  'Get UTxO details for requested scripts'; -- noqa: LT01
