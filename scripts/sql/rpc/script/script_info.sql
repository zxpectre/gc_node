CREATE OR REPLACE FUNCTION {{SCHEMA}}.script_info(_script_hashes text [])
RETURNS TABLE (
  script_hash text,
...
COMMENT ON FUNCTION {{SCHEMA}}.script_info IS  'Get information about a given script FROM hashes.'; -- noqa: LT01
