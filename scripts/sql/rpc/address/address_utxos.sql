CREATE OR REPLACE FUNCTION {{SCHEMA}}.address_utxos(_addresses text [], _extended boolean DEFAULT false)
RETURNS TABLE (
  tx_hash text,
  tx_index smallint,
  address text,
...
COMMENT ON FUNCTION {{SCHEMA}}.address_utxos IS  'Get UTxO details for requested addresses'; -- noqa: LT01
