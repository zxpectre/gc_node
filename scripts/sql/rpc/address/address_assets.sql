CREATE OR REPLACE FUNCTION {{SCHEMA}}.address_assets(_addresses text [])
RETURNS TABLE (
  address varchar,
  policy_id text,
  asset_name text,
...
COMMENT ON FUNCTION {{SCHEMA}}.address_assets IS 'Get the list of all the assets (policy, name and quantity) for given addresses'; --noqa: LT01
