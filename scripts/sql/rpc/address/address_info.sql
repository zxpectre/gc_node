CREATE OR REPLACE FUNCTION {{SCHEMA}}.address_info(_addresses text [])
RETURNS TABLE (
  address varchar,
  balance text,
...
COMMENT ON FUNCTION {{SCHEMA}}.address_info IS 'Get bulk address info - balance, associated stake address (if any) and UTXO set'; -- noqa: LT01
